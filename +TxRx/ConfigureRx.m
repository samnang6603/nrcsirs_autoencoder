...
decDLSCH.LDPCDecodingAlgorithm = simParams.PDSCHExtension.LDPCDecodingAlgorithm;
decDLSCH.MaximumLDPCIterationCount = simParams.PDSCHExtension.MaximumLDPCIterationCount;
...
if channel.NormalizeChannelOutpus
...
channelClone.ChannelFiltering = true;
...
csiReports = CSIReport.EncodeCSI(carrier,csirs,Hest,noiseEst,csiFeedbackOpts);
csiAvailableSlots = 0;
